...
<head>
    ...
    <title>TecnoStock - Editar Cliente</title>
...
<body class="p-4 sm:p-8 flex justify-center items-start min-h-screen">
    <div class="w-full max-w-xl glass-panel rounded-3xl p-6 sm:p-10 shadow-2xl my-6">
        ...
        <div class="flex items-center justify-between gap-4 mb-6 pb-4 border-b border-slate-700/50">
            ...
            <a href="cliente?opcion=gestionar" class="px-3 py-1.5 text-xs font-semibold text-slate-300 hover:text-white bg-slate-800/80 hover:bg-slate-700/80 border border-slate-700 rounded-xl transition-all">
                Volver al Listado
            </a>
        </div>
